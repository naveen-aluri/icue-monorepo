...
import 'hrms_api_client.dart' as _i67;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i1013.ApiClient>(
      () => _i1013.ApiClient(gh<_i487.CrashlyticsService>()),
    );
    gh.lazySingleton<_i67.HrmsApiClient>(
      () => _i67.HrmsApiClient(gh<_i487.CrashlyticsService>()),
    );
